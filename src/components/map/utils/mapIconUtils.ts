...
export const createCustomIcon = (
  ...
  // Ajouter un contour bleu pour les données corrigées (AtmoMicro) si le feature flag est false
  if (device.source === "atmoMicro" && device.has_correction && !featureFlags.correctedCheck) {
